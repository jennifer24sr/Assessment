...
function nameValidation () {
    ...
    if(nameInput ==""){
        ...
        if(namePattern.test(nameInput)){
            ...
            idForName.style.color="lightgreen";
            idForName.innerHTML="";
            nameId.style.borderBottom ="lightgreen solid 2px";
            return true;
        }
...
function emailValidation () {
    ...
    if(emailInput==""){
        ...
        if(emailPattern.test(emailInput)){
            ...
            idForEmail.style.color="lightgreen";
            emailId.style.borderBottom ="lightgreen solid 2px";
            return true;
        }
        else{
...
function passwordValidation () {
    ...
    if(passwordInput == ""){
        ...
        if(passwordPattern.test(passwordInput)) {
            ...
            passwordId.style.borderBottom = "lightgreen solid 2px";
            idForPassword.innerHTML = "Valid Password";
            idForPassword.style.color = "lightgreen";
            return true;
        }
        else {
...
function passwordConfirmationValidation () {
    ...
    if(passwordConfirmationInput != document.getElementById("password").value){
        ...
        passwordConfirmationId.style.borderBottom = "lightgreen solid 2px";
        idForPasswordConfirmation.innerHTML = "Password matched";
        idForPasswordConfirmation.style.color = "lightgreen";
        return true;
    }
}
